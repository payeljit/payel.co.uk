...
<main>
  ...
  <!-- <div id="intro" class="row payel-image  intro text-center" style="background: url('<?php echo get_template_directory_uri() . '/assets/img/portfolio-background-light.png' ?>');   background-position: 100%; background-size: cover; background-repeat: no-repeat; "> -->
    ...
    <div class="col-12"  id="about">
      ...
      <h4 class="mb-4">Front end developer</h4>
      <p> My name is Payel Banerjee. I am a passionate Front End Web Developer. Currently working for a service providing company Cogora.&nbsp;
...
<div class="row my-skills"  id="skills">
  ...
  <div class="col-12 col-md-3 col-lg-3">
    ...
    <div class="languages"><?php echo do_shortcode("[PROGRESSBAR_WP id=25]"); ?></div>
  </div>
  <div class="col-12 col-md-3 col-lg-3">
    <strong>  Tools</strong>
    <div class="languages"><?php echo do_shortcode("[PROGRESSBAR_WP id=24]"); ?></div>

  </div>
  <div class="col-12 col-md-3 col-lg-3">
    <strong>  Editor</strong>
    <div class="languages"><?php echo do_shortcode("[PROGRESSBAR_WP id=23]"); ?></div>
  </div>
  <div class="col-12 col-md-3 col-lg-3">
    <strong>  CMS</strong>
    <div class="languages"><?php echo do_shortcode("[PROGRESSBAR_WP id=22]"); ?></div>
  </div>
</div>
